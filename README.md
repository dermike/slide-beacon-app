...
**[Download pre-built binary](https://github.com/dermike/electron-slide-beacon/releases/download/v0.1.0/EddystoneURL_0.1.0.zip)** or follow the instructions below to run or build your own binary.
